...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    private static final int[] BUCKETS = {20,50,100,200,500, 1000,2000,3000,5000};
     ...
     */
    private  int MIN_CLUSTER_SIZE = 2;
    ...
    private LayerDrawable makeClusterBackground() {
        ...
        outline.getPaint().setColor(0x66ffff99); // Transparent white.
    ...
    protected String getClusterText(int bucket) { if (bucket < BUCKETS[0]) {
...
//        return BUCKETS[BUCKETS.length - 1];
    ...
    protected void onBeforeClusterRendered(Cluster<T> cluster, MarkerOptions markerOptions) {
        ...
        if (descriptor == null) {
            ...
            mColoredCircleBackground.setAlpha(130);
